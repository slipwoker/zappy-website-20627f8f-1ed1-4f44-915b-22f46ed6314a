document.addEventListener('DOMContentLoaded', function() {
            ...
            fetch(action, options)
                ...
                .then(function() {
                    ...
                    if (!form.querySelector('.form-success')) {
                        ...
                        successMessage.textContent = form.getAttribute('data-success-message') || 'Thank you! Your message has been sent successfully.';
                ...
                .catch(function() {
                    ...
                    if (!form.querySelector('.form-error')) {
                        ...
                        errorMessage.textContent = form.getAttribute('data-error-message') || 'Something went wrong. Please try again later.';
                ...
                .finally(function() {
                    if (submitButton) {
                        ...
                        submitButton.value = submitButton.getAttribute('data-original-text') || originalText;
                    }
                });
        }
    }
    ...
    function handleFormInput(e) {
        ...
        if (field.closest('.contact-form') && (field.tagName === 'INPUT' || field.tagName === 'TEXTAREA' || field.tagName === 'SELECT')) {
            if (field.type !== 'submit' && field.type !== 'button' && field.type !== 'hidden') {
                validateField(field);
            }
        }
    ...
    function handleScrollAnimations() {
        animatedElements.forEach(function(el) {
            if (isElementInViewport(el, 100)) {
                el.classList.add('visible', 'in-view', 'animated');
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('blur', handleFormBlur, true);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '20627f8f-1ed1-4f44-915b-22f46ed6314a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '20627f8f-1ed1-4f44-915b-22f46ed6314a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '20627f8f-1ed1-4f44-915b-22f46ed6314a';
